...
var errorMessages_1 = __importStar(__webpack_require__(/*! ../utils/errorMessages */ "./src/utils/errorMessages.ts"));
...
var AppConfig = /** @class */ (function () {
     ...
     */
    AppConfig.prototype.setValidity = function (isValid, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (typeof isValid !== "boolean") {
                    throw new TypeError((0, errorMessages_1.default)(errorMessages_1.ERROR_MESSAGES.configPage.setValidity.isValidTypeBoolean));
                }
                if ((options === null || options === void 0 ? void 0 : options.message) && typeof options.message !== "string") {
                    throw new TypeError((0, errorMessages_1.default)(errorMessages_1.ERROR_MESSAGES.configPage.setValidity.messageTypeString));
                }
                return [2 /*return*/, this._connection
                        .sendToParent("setValidity", { isValid: isValid, options: options })
                        .then(utils_1.onData)
                        .catch(utils_1.onError)];
            });
        });
    ...
    Entry.prototype.getField = function (uid, options) {
        ...
        try {
            ...
            path.forEach(function (key, index) {
                ...
                else if ((schema.data_type === "group" ||
                    schema.data_type === "global_field") &&
                ...
                else if (schema.data_type === "blocks" &&
                    path.length !== index + 1) {
...
var field_1 = __importDefault(__webpack_require__(/*! ./field */ "./src/field.ts"));
var entry_2 = __importDefault(__webpack_require__(/*! ./fieldModifierLocation/entry */ "./src/fieldModifierLocation/entry.ts"));
var field_2 = __importDefault(__webpack_require__(/*! ./fieldModifierLocation/field */ "./src/fieldModifierLocation/field.ts"));
var frame_1 = __importDefault(__webpack_require__(/*! ./fieldModifierLocation/frame */ "./src/fieldModifierLocation/frame.ts"));
...
var Extension = /** @class */ (function () {
    function Extension(initData) {
        var _this = this;
        var _a, _b;
        this.pulse = function (eventName, metadata) {
            _this.postRobot.sendToParent("analytics", { eventName: eventName, metadata: metadata });
        };
        ...
        this.getAppVersion = function () { return __awaiter(_this, void 0, void 0, function () {
            var orgUid, options, app;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.version) {
                            return [2 /*return*/, Promise.resolve(this.version)];
                        }
                        if (!this.installationUID) {
                            return [2 /*return*/, Promise.resolve(null)];
                        }
                        orgUid = this.stack._data.org_uid;
                        options = {
        ...
        window["postRobot"] = post_robot_1.default;
        this.modal = new modal_1.default();
        this.region = (0, utils_1.formatAppRegion)(initializationData.data.region);
        this.version = ((_b = initializationData.data.manifest) === null || _b === void 0 ? void 0 : _b.version) || null;
        var stack = new stack_1.default(initializationData.data.stack, post_robot_1.default, {
            currentBranch: initializationData.data.currentBranch,
        });
...
/***/ "./src/fieldModifierLocation/entry.ts":
/*!********************************************!*\
  !*** ./src/fieldModifierLocation/entry.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var entry_1 = __importDefault(__webpack_require__(/*! ../entry */ "./src/entry.ts"));
var errorMessages_1 = __importStar(__webpack_require__(/*! ../utils/errorMessages */ "./src/utils/errorMessages.ts"));
var field_1 = __importDefault(__webpack_require__(/*! ./field */ "./src/fieldModifierLocation/field.ts"));
var FieldModifierLocationEntry = /** @class */ (function (_super) {
    __extends(FieldModifierLocationEntry, _super);
    function FieldModifierLocationEntry(initializationData, connection, emitter) {
     ...
     */
    FieldModifierLocationEntry.prototype.getTags = function (options) {
        var _a;
     ...
     * @returns {string[]} Returns an array of tags associated with the entry.
     */
    FieldModifierLocationEntry.prototype.setTags = function (tags) {
        return __awaiter(this, void 0, void 0, function () {
            /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (tags === undefined) {
                            throw new Error((0, errorMessages_1.default)(errorMessages_1.ERROR_MESSAGES.entryField.entry.tagsShouldNotBeBlank));
                        }
                        if (!areTagsValid(tags)) {
                            throw new Error((0, errorMessages_1.default)(errorMessages_1.ERROR_MESSAGES.entryField.entry.tagsShouldBeArrayOfStrings));
                        }
                        return [4 /*yield*/, this._connection.sendToParent("setTags", { tags: tags })];
                    case 1:
                        _a.sent();
    ...
    return FieldModifierLocationEntry;
}(entry_1.default));
exports["default"] = FieldModifierLocationEntry;
...
/** Class representing a field from Contentstack UI. Only available for Custom Field extension */
var FieldModifierLocationField = /** @class */ (function () {
    function FieldModifierLocationField(fieldDataObject, connection, emitter) {
        /**
         * The UID of the current field is defined in the content type of the entry.
         * @type {string}
         */
     ...
     * @return {external:Promise} A promise object which is resolved when data is set for a field. Note: The data set by this function will only be saved when user saves the entry.
     */
    FieldModifierLocationField.prototype.setData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var currentFieldObj, dataObj;
            var _this = this;
            return __generator(this, function (_a) {
                currentFieldObj = this;
                dataObj = {
                    data: data,
                    uid: currentFieldObj.uid,
                    self: currentFieldObj._self,
                ...
                if (!currentFieldObj._self &&
                    (excludedDataTypesForSetField.indexOf(currentFieldObj.data_type) !==
                        -1 ||
                        !currentFieldObj.data_type)) {
                    return [2 /*return*/, Promise.reject(new Error("Cannot call set data for current field type"))];
                }
                return [2 /*return*/, this._connection
                        .sendToParent("setData", dataObj)
                        .then(function () {
     ...
     * @return {Object|string|number} Returns the field data.
     */
    FieldModifierLocationField.prototype.getData = function (_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.resolved, resolved = _c === void 0 ? false : _c;
        return resolved ? this._resolvedData : this._data;
    };
    return FieldModifierLocationField;
}());
exports["default"] = FieldModifierLocationField;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var post_robot_1 = __importDefault(__webpack_require__(/*! post-robot */ "./node_modules/post-robot/index.js"));
var errorMessages_1 = __webpack_require__(/*! ../utils/errorMessages */ "./src/utils/errorMessages.ts");
/**
 * Class representing an iframe window from Contentstack UI. Not available for Custom Widgets.
 */
var FieldModifierLocationFrame = /** @class */ (function () {
    function FieldModifierLocationFrame(connection, emitter) {
     ...
     */
    FieldModifierLocationFrame.prototype.updateDimension = function (dimension) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, height, width, dimensionBody;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = dimension || {}, height = _a.height, width = _a.width;
                        if (!(height === undefined && width === undefined)) return [3 /*break*/, 2];
                        ...
                        return [4 /*yield*/, this._connection.sendToParent("resize", {
                                height: this._height,
                                width: this._width,
                            })];
                    case 1:
                    ...
                    case 2:
                        ...
                        if (height !== undefined && typeof height !== "number") {
                            throw new Error(errorMessages_1.ERROR_MESSAGES.entryField.frame.dimensionHeightShouldBeNumber);
                        }
                        ...
                        if (width !== undefined && typeof width !== "number") {
                            throw new Error(errorMessages_1.ERROR_MESSAGES.entryField.frame.dimensionWidthShouldBeNumber);
                        }
                        if (this._width !== width) {
                            this._width = width;
                            dimensionBody["width"] = this._width;
                        }
                        if (!(Object.keys(dimensionBody).length !== 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this._connection.sendToParent("resize", dimensionBody)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
     ...
     */
    FieldModifierLocationFrame.prototype.preventFrameClose = function (state) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._connection.sendToParent("preventFrameClose", {
                            state: state,
                        })];
                    case 1:
                        _a.sent();
     ...
     */
    FieldModifierLocationFrame.prototype.enableAutoResizing = function () {
        var _this = this;
        if (this._autoResizingEnabled) {
            return this;
        }
        this._autoResizingEnabled = true;
        this.observer = new MutationObserver(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.updateDimension()];
     ...
     * @return {FieldModifierLocationFrame}.
     */
    FieldModifierLocationFrame.prototype.disableAutoResizing = function () {
        var _a;
        if (!this._autoResizingEnabled) {
            return this;
        }
    ...
    FieldModifierLocationFrame.prototype.updateParentContainerStyle = function (controlStyleFromApp) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._connection.sendToParent("updateParentContainerStyle", { controlStyleFromApp: controlStyleFromApp })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    FieldModifierLocationFrame.prototype.closeModal = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._connection.sendToParent("closeModal")];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
exports["default"] = FieldModifierLocationFrame;
...
var Modal = /** @class */ (function () {
    function Modal() {
        ...
        if (!Object.prototype.hasOwnProperty.call(window, "iframeRef")) {
            var rootElement = (0, utils_1.getPreferredBodyElement)((_a = document === null || document === void 0 ? void 0 : document.body) === null || _a === void 0 ? void 0 : _a.children);
            window["iframeRef"] = rootElement;
        }
    }
    Modal.prototype.setBackgroundElement = function (element) {
...
var Stack = /** @class */ (function () {
     ...
     */
    Stack.prototype.getManagementTokens = function () {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            var _this = this;
            return __generator(this, function (_a) {
                options = { action: "getManagementTokens" };
                return [2 /*return*/, this._connection
                        .sendToParent("stackQuery", options)
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, utils_1.onData)(response)];
                                case 1:
                                    data = _a.sent();
     ...
     */
    Stack.prototype.getReleases = function (query, params) {
        if (query === void 0) { query = {}; }
        if (params === void 0) { params = {}; }
        var optionParams = params;
        optionParams.query = query;
        var options = { params: optionParams, action: 'getReleases' };
        return this._connection.sendToParent('stackQuery', options).then(utils_1.onData).catch(utils_1.onError);
    };
    /**
     ...
     */
    Stack.prototype.getPublishes = function (query, params) {
        if (query === void 0) { query = {}; }
        if (params === void 0) { params = {}; }
        var optionParams = params;
        optionParams.query = query;
        var options = { params: optionParams, action: 'getPublishes' };
        return this._connection.sendToParent('stackQuery', options).then(utils_1.onData).catch(utils_1.onError);
    };
    /**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Region = exports.OrganizationLocation = exports.StackLocation = void 0;
var StackLocation;
(function (StackLocation) {
    StackLocation["STACK_CONFIG"] = "cs.cm.stack.config";
    StackLocation["DASHBOARD"] = "cs.cm.stack.dashboard";
    StackLocation["SIDEBAR"] = "cs.cm.stack.sidebar";
    StackLocation["CUSTOM_FIELD"] = "cs.cm.stack.custom_field";
    StackLocation["RTE"] = "cs.cm.stack.rte";
})(StackLocation = exports.StackLocation || (exports.StackLocation = {}));
var OrganizationLocation;
(function (OrganizationLocation) {
    OrganizationLocation["ORG_CONFIG"] = "cs.org.config";
})(OrganizationLocation = exports.OrganizationLocation || (exports.OrganizationLocation = {}));
var Region;
(function (Region) {
    Region["UNKNOWN"] = "UNKNOWN";
    Region["NA"] = "NA";
    Region["EU"] = "EU";
    Region["AZURE_NA"] = "AZURE_NA";
    Region["AZURE_EU"] = "AZURE_EU";
...
function generateErrorMessages(message) {
    return "Contentstack App SDK: " + message;
}
exports["default"] = generateErrorMessages;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getPreferredBodyElement = exports.formatAppRegion = exports.onError = exports.onData = void 0;
...
function formatAppRegion(region) {
    switch (region) {
        case "NA":
            return types_1.Region.NA;
        case "EU":
            return types_1.Region.EU;
        case "AZURE_NA":
            return types_1.Region.AZURE_NA;
        case "AZURE_EU":
            return types_1.Region.AZURE_EU;
        default:
            return types_1.Region.UNKNOWN;
    }
}
exports.formatAppRegion = formatAppRegion;
function getPreferredBodyElement(nodeCollection) {
    var rootElementIndex = Infinity;
    var rootElement;
    var elementPreferenceList = [
        "HEADER",
        "NAV",
        "MAIN",
        "SECTION",
    ...
    var nonRenderingTags = ["SCRIPT", "NOSCRIPT", "STYLE", "TEMPLATE"];
    // ? choose higher preference semantic HTML tags
    Array.from(nodeCollection).forEach(function (el) {
        var elIndex = elementPreferenceList.indexOf(el.nodeName);
    ...
    if (!rootElement) {
        rootElement = Array.from(nodeCollection).find(function (el) { return !nonRenderingTags.includes(el.nodeName); });
    }
    return rootElement || nodeCollection[0];
}
exports.getPreferredBodyElement = getPreferredBodyElement;
