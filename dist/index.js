...
/***/ "./src/entryFieldLocation/entry.ts":
/*!*****************************************!*\
  !*** ./src/entryFieldLocation/entry.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var field_1 = __importDefault(__webpack_require__(/*! ./field */ "./src/entryFieldLocation/field.ts"));
var EntryFieldLocationEntry = /** @class */ (function (_super) {
    __extends(EntryFieldLocationEntry, _super);
    function EntryFieldLocationEntry(initializationData, connection, emitter) {
     ...
     */
    EntryFieldLocationEntry.prototype.getTags = function (options) {
        var _a;
     ...
     * @returns {string[]} Returns an array of tags associated with the entry.
     */
    EntryFieldLocationEntry.prototype.setTags = function (tags) {
        return __awaiter(this, void 0, void 0, function () {
            /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (tags === undefined) {
                            throw new Error(errorMessages_1.errorMessage.entryField.entry.tagsShouldNotBeBlank);
                        }
                        if (!areTagsValid(tags)) {
                            throw new Error(errorMessages_1.errorMessage.entryField.entry.tagsShouldBeArrayOfStrings);
                        }
    ...
    return EntryFieldLocationEntry;
}(entry_1.default));
exports["default"] = EntryFieldLocationEntry;


/***/ }),

/***/ "./src/entryFieldLocation/field.ts":
/*!*****************************************!*\
  !*** ./src/entryFieldLocation/field.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports) {
...
var EntryFieldLocationField = /** @class */ (function () {
    function EntryFieldLocationField(fieldDataObject, connection, emitter) {
        /**
     ...
     */
    EntryFieldLocationField.prototype.setData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    EntryFieldLocationField.prototype.getData = function (_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.resolved, resolved = _c === void 0 ? false : _c;
        return resolved ? this._resolvedData : this._data;
    };
    return EntryFieldLocationField;
}());
exports["default"] = EntryFieldLocationField;
 ...
 */
var EntryFieldLocationFrame = /** @class */ (function () {
    function EntryFieldLocationFrame(connection, emitter) {
     ...
     */
    EntryFieldLocationFrame.prototype.updateDimension = function (dimension) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (height !== undefined && typeof height !== "number") {
                            throw new Error(errorMessages_1.errorMessage.entryField.frame.dimensionHeightShouldBeNumber);
                        }
                        ...
                        if (width !== undefined && typeof width !== "number") {
                            throw new Error(errorMessages_1.errorMessage.entryField.frame.dimensionWidthShouldBeNumber);
                        }
     ...
     */
    EntryFieldLocationFrame.prototype.enableAutoResizing = function () {
        var _this = this;
     ...
     * @return {EntryFieldLocationFrame}.
     */
    EntryFieldLocationFrame.prototype.disableAutoResizing = function () {
        var _a;
        if (!this._autoResizingEnabled) {
            return this;
        }
     ...
     */
    EntryFieldLocationFrame.prototype.closeModal = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports["default"] = EntryFieldLocationFrame;
...
var field_2 = __importDefault(__webpack_require__(/*! ./entryFieldLocation/field */ "./src/entryFieldLocation/field.ts"));
var frame_1 = __importDefault(__webpack_require__(/*! ./entryFieldLocation/frame */ "./src/entryFieldLocation/frame.ts"));
var entry_2 = __importDefault(__webpack_require__(/*! ./entryFieldLocation/entry */ "./src/entryFieldLocation/entry.ts"));
