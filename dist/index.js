    ...
    return (
        (t = {
                    ...
                    (t.exports = (function (t) {
                        ...
                        "./src/index.js": function (t, e, n) {
                                ...
                                R =
                                    ...
                                    }),
                                    {
                                        ...
                                        ALLOWED_POST_MESSAGE_METHODS:
                                            ((S = {}),
                                            (S[T.SEND_STRATEGIES.POST_MESSAGE] =
                                                !0),
                                            (S[T.SEND_STRATEGIES.BRIDGE] = !0),
                                            (S[T.SEND_STRATEGIES.GLOBAL] = !0),
                                            S),
                                        ALLOW_SAME_ORIGIN: !1,
                                    });
                            0 ===
                                window.location.href.indexOf(T.FILE_PROTOCOL) &&
                            ...
                            var K = (function () {
                                ...
                                H = (window[T.WINDOW_PROPS.POSTROBOT] =
                                    window[T.WINDOW_PROPS.POSTROBOT] || {});
                            ...
                            H.methods = H.methods || new A();
                            var Y = M(function () {
                                H.on(
                                    T.POST_MESSAGE_NAMES.METHOD,
                                    { origin: T.WILDCARD },
                                    function (t) {
                                        var e = t.source,
                                            n = t.origin,
                            ...
                            function J(t, e, n, r) {
                                ...
                                return (
                                    ...
                                    {
                                        __type__: T.SERIALIZATION_TYPES.METHOD,
                                        __id__: o,
                                        __name__: r,
                                    }
                                );
                            ...
                            function $(t, e, n) {
                                return new K(function (r, o) {
                                    return V(t, e, n.__then__)(r, o);
                                });
                            }
                            function X(t) {
                                return H.send(
                                    t,
                                    T.POST_MESSAGE_NAMES.HELLO,
                                    {},
                                    { domain: T.WILDCARD, timeout: -1 }
                                ).then(function (t) {
                                    return { origin: t.origin };
                                });
                            }
                            H.readyPromises = H.readyPromises || new A();
                            var tt = {};
                            tt[T.SEND_STRATEGIES.POST_MESSAGE] = function (
                                t,
                                e,
                                n
                            ) {
                                (Array.isArray(n)
                                    ...
                                    .map(function (e) {
                                        if (0 === e.indexOf(T.MOCK_PROTOCOL)) {
                                            if (
                                        ...
                                        return 0 === e.indexOf(T.FILE_PROTOCOL)
                                            ? T.WILDCARD
                                            : e;
                                    })
                                    .forEach(function (n) {
                            ...
                            function nt(t, e, n) {
                                return K.try(function () {
                                        ...
                                        ((e = (function (t, e) {
                                            var n =
                                                ...
                                                o = (function () {
                                                    ...
                                                    ? T.WINDOW_TYPES.IFRAME
                                                    : T.WINDOW_TYPES.FULLPAGE,
                                                i = p(window);
                                            return et({}, e, n, {
                                                sourceDomain: i,
                                                id: e.id || r,
                                    ...
                                    return K.map(Object.keys(tt), function (e) {
                                        return K.try(function () {
                                            if (
                                                !R.ALLOWED_POST_MESSAGE_METHODS[
                                                    e
                                                ]
                                            )
                                                throw new Error(
                                                    "Strategy disallowed: " + e
                                                );
                                            return tt[e](t, i, n);
                                        }).then(
                                            function () {
                            ...
                            var ut =
                                ...
                                ct =
                                    ...
                                    (rt[T.POST_MESSAGE_TYPE.REQUEST] =
                                        function (t, e, n) {
                                            var r = st({
                                                name: n.name,
                                                win: t,
                                    ...
                                    (rt[T.POST_MESSAGE_TYPE.RESPONSE] =
                                        function (t, e, n) {
                                            if (!at(n.hash)) {
                                                var r,
                                                    i = ot(n.hash);
                            ...
                            function mt(t) {
                                ...
                                var e,
                                    ...
                                    a = (function t(e, n) {
                                        ...
                                        var v = H.requestListeners,
                                            m = v[r];
                                        m || ((m = new A()), (v[r] = m));
                                        var g = m.get(o);
                                        g || ((g = {}), m.set(o, g));
                                        var w = i.toString(),
                                            b = g.__domain_regex__,
                                            E = void 0;
                                        return (
                                            I(i)
                                                ? (b ||
                                                      ((b = []),
                                                      (g.__domain_regex__ = b)),
                                                  (E = {
                                                      regex: i,
                                                      listener: n,
                                                  }),
                            ...
                            function Et() {
                                delete window[T.WINDOW_PROPS.POSTROBOT],
                            ...
                            function Pt(t) {
                                ...
                                H.popupWindowsByWin &&
                                    H.popupWindowsByWin.delete(t),
                                    H.remoteWindows &&
                                        H.remoteWindows.delete(t),
                                    ...
                                    (function () {
                                        (t = function (t) {
                                            var e = t.source,
                                                n = t.origin,
                                                r =
                                                    H.readyPromises.get(e) ||
                                                    new K();
                                            r.resolve({ origin: n }),
                                                H.readyPromises.set(e, r);
                                        }),
                                            H.on(
                                                T.POST_MESSAGE_NAMES.HELLO,
                                                { domain: T.WILDCARD },
                    ...
                    i = (function () {
                        function t(t, e, n, r) {
                            (this.content_type = t.data.content_type),
                                ...
                                t.data.changedData &&
                                    (this._changedData = t.data.changedData),
                    ...
                    O = (function () {
                        function t(t) {
                            ...
                            (this.pulse = function (t, e) {
                                r.postRobot.sendToParent("analytics", {
                                    eventName: t,
                                    metadata: e,
                                });
                            }),
                            ...
                            (this.postRobot = s.default),
                                ...
                                (this.installationUID =
                                    o.data.installation_uid),
                                (this.currentUser = o.data.user),
                                (this.type = o.data.type),
                                (this.store = new g.default(s.default)),
                                (this.stack = new m.default(
                                    o.data.stack,
                                    s.default,
                                    { currentBranch: o.data.currentBranch }
                                )),
                                (this.metadata = new _.default(s.default)),
                                (this.config =
                                    null !== (e = o.data.config) && void 0 !== e
                                        ? e
                                        : {}),
                                (this.location = {
                                ...
                                (window.postRobot = s.default),
                                (this.modal = new v.default()),
                                (this.region = (0, w.formatAppRegion)(
                                    o.data.region
                                ));
                            var a = new m.default(o.data.stack, s.default, {
                                currentBranch: o.data.currentBranch,
                            });
                            switch (o.data.type) {
                                case "DASHBOARD":
                                ...
                                case "WIDGET":
                                    this.location.SidebarWidget = {
                                        entry: new f.default(o, s.default, E),
                                        stack: new m.default(
                                            o.data.stack,
                                            s.default,
                                            {
                                ...
                                case "ENTRY_FIELD_LOCATION":
                                    (o.data.self = !0),
                                        (this.location.FieldModifierLocation = {
                                            ...
                                            frame: new y.default(s.default, E),
                                        });
                                    break;
                            ...
                            try {
                                s.default.on("extensionEvent", function (t) {
                                    "entrySave" === t.data.name &&
                                        (E.emitEvent("entrySave", [
                                            { data: t.data.data },
                                        ]),
                                        E.emitEvent("updateFields", [
                                            { data: t.data.data },
                                        ])),
                                        "entryChange" === t.data.name &&
                                            E.emitEvent("entryChange", [
                                                {
                                                    data: t.data.data,
                                                    resolvedData:
                                                        t.data.otherData
                                        ...
                                        "entryPublish" === t.data.name &&
                                            E.emitEvent("entryPublish", [
                                                { data: t.data.data },
                                            ]),
                                        "entryUnPublish" === t.data.name &&
                                            E.emitEvent("entryUnPublish", [
                                                { data: t.data.data },
                                            ]),
                                        "assetSave" === t.data.name &&
                                            (E.emitEvent("assetSave", [
                                                { data: t.data.data },
                                            ]),
                                            E.emitEvent("updateFields", [
                                                { data: t.data.data },
                                        ...
                                        "assetChange" === t.data.name &&
                                            E.emitEvent("assetChange", [
                                                { data: t.data.data },
                                            ]),
                                        "assetPublish" === t.data.name &&
                                            E.emitEvent("assetPublish", [
                                                { data: t.data.data },
                                            ]),
                                        "assetUnPublish" === t.data.name &&
                                            E.emitEvent("assetUnPublish", [
                                                { data: t.data.data },
                                            ]),
                                        "dashboardResize" === t.data.name &&
                                            E.emitEvent("dashboardResize", [
                                                { state: t.data.state },
                                            ]),
            ...
            974: (t, e, n) => {
                "use strict";
                Object.defineProperty(e, "__esModule", { value: !0 }),
                    (e.formatAppRegion = e.onError = e.onData = void 0);
                var r = n(699);
                (e.onData = function (t) {
                    return "string" == typeof t.data
                        ? Promise.reject(t.data)
